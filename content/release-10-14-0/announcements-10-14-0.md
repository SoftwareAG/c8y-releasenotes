...
As announced with [release 10.13](/release-10-14-0/announcements-10-14-0) as of release 10.14, for the Inventory API, a set of properties has been restricted for internal system usage and cannot be set by external users. This change is motivated by performance improvements.
