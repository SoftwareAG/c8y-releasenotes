...
<td>
Cockpit</td>
<td> The asset selector dialog, which shows up to select devices or groups when creating or editing widgets, has been updated. It is now also possible to filter assets on each hierarchy level. This change does not apply to widgets related to datapoints.</td>
