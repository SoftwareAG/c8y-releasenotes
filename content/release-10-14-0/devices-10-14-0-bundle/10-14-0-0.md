...
<td>
<b>NEW:</b>: Device Management </td>
<td> Permissions are now required to access the Advanced Software Management microservice.
For GET endpoints either the ROLE_ADVANCED_SOFTWARE_READ role is required or READ access to the specified device ID.
For POST, PUT, DELETE endpoints either the ROLE_ADVANCED_SOFTWARE_ADMIN role is required or ADMIN access to the specified device ID. </td>
<td>
DM-365</td>
</tr>
