...
Cumulocity IoT DataHub now uses version 22 of Dremio as query engine. The new version comes along with various enhancements and improvements like performance improvements and optimized data lake access.
