...
<tr>
<td>Sigfox</td>
<td>The Sigfox agent earlier used to support only one connectivity setting per tenant. 
    <br>Now multiple connections can be configured per tenant and devices can be associated to any one of the connections.
    <br>A connection can also be updated and deleted.
</td>
<td>DM-543</td>
</tr>
...
<tr>
<td>Actility</td>
<td>The Actility agent earlier used to support only one connectivity setting per tenant. 
    <br>Now multiple connections can be configured per tenant and devices can be associated to any one of the connections.
    <br>A connection can also be updated and deleted.
</td>
<td>DM-543</td>
