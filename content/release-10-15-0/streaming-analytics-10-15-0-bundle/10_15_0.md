...
- Improved performance for all rules, models and apps that were previously limited in performance because they had to wait for other Streaming Analytics platform requests to complete before they could make their own requests.
