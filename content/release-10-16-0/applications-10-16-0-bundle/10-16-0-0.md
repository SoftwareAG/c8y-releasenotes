...
<tr>
<td>Java SDK</td>
<td>Fixed an issue with the AlarmRepresentation comparison in equals and hashcode methods. Now, instead of comparing the full ManagedObjectRepresentation as source of alarms, we only compare the managed objects ID. There is no change in ManagedObjectRepresentation.</td>
<td>MTM-49181</td>
</tr>
