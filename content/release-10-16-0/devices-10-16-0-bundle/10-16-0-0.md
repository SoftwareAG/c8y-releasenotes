...
<tr>
<td>LWM2M</td>
<td>LWM2M 1.1 allows direct writing to a resource instance. That means if you have a resource, which has some resource instances (as an example /3/0/11/0) and these resource instances allows direct write, it's possible to write values to any of the resource instances.</td>
<td>DM-371</td>
</tr>
