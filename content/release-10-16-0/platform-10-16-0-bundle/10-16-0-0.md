...
Additionally, a small change has been made to improve an existing error message logged when forwarding to the destination tenant fails.</td>
<td>
MTM-47731</td>
</tr>
...
<td>
Rest API</td>
<td>The detail() and delete() method of the @c8y/client MeasurementService has been marked as deprecated as it is not supported with the new timeseries.</td>
<td>
MTM-48529</td>
