...
<td>Application packages can now be shared with subtenants by setting their availability to SHARED. This way the packages don´t have to be subscribed individually per tenant, and a subtenant can select from a variety of packages if available and shared by their parent or Management tenant.</td>
<td>MTM-47169</td>
</tr>
