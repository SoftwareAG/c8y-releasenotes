...
### Changed location of diagnostics links
...
In addition, the right drawer now also provides a **Documentation** section with links to the Analytics Builder, EPL Apps and smart rules documentation.
