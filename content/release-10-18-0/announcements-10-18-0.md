...
As announced with [release 10.17](/release-10-17-0/announcements-10-17-0) shared classes, components and services defined in @c8y/ngx-components/device-grid are now moved to @c8y/ngx-components. Therefore the obsolete items are deprecated.
