...
<td>
Two-factor authentication</td>
<td> Resolved an issue where the preferred login mode has not been updated after re-login. The user must no longer refresh after re-login to display the correct login mode.</td>
<td>
MTM-40778</td>
</tr>
</tbody></table></div>
